...
<div>
  <el-form :model="RegisterForm"  label-width="100px" class="login-box">
    ...
    <el-form-item label="店主名">
      <el-input type="text" v-model="RegisterForm.name" style="width: 200px" placeholder="请输入店主名"></el-input>
    </el-form-item>
    <el-form-item label="商家地址">
      <el-input type="text" v-model="RegisterForm.address" style="width: 200px" placeholder="请输入商家地址"></el-input>
    </el-form-item>
...
export default {
  ...
  methods:{
    RegForm(){
      ...
      this.axios({
        method: 'get',
        url:'http://localhost:8081/store/enroll/'+this.RegisterForm.username+ '/'+this.RegisterForm.password+'/'
